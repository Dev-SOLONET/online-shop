    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home  text-center">
                <img src="{{ url('multikart/assets/images/home-banner/1.jpg') }}" alt=""
                        ...
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <h4>HOT PROMO</h4>
                                    <h1>men fashion</h1>
                                    <a href="#" class="btn btn-solid">Beli Sekarang</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row partition2">
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center">
                        <div class="img-part">
                            <img src="{{ url('multikart/assets/images/sub-banner1.jpg') }}"
            ...
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center">
                        <div class="img-part">
                            <img src="{{ url('multikart/assets/images/sub-banner2.jpg') }}"
                                class="img-fluid blur-up lazyload bg-img" alt="">
                        </div>
                        <div class="contain-banner">
                            <div>
...
<div class="title1 section-t-space">
    ...
    <h2 class="title-inner1">Produk Terbaru</h2>
</div>
<div class="container">
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            <div class="product-para">
                <p class="text-center">Mencari tren terbaru dalam pakaian, sepatu dan aksesoris? Selamat datang di produk terbaru kami, kami akan membawa semua gaya terbaru dari semua merek favorit Anda.</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="cart-info cart-wrap">
                                ...
                                <a href="{{ route('home.show', $items->slug )}}" data-bs-toggle="modal" data-bs-target="#quick-view" title="Quick View">
                        ...
                        <div class="product-detail">
                            ...
                            <h4>Rp. {{ number_format($items->one_detail_barang->harga) }}</h4>
...
<!-- Tab product -->
<div class="title1 section-t-space">
    <h4>Produk Exclusive</h4>
    <h2 class="title-inner1">Brand Terlengkap</h2>
</div>
<section class="section-b-space pt-0 ratio_asos">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="theme-tab">
                    <ul class="tabs tab-title">
                        ...
                        @if ($no == 1)
                        <li class="current"><a data-toggle="tab" href="{{ $data->nama }}">{{ $data->nama }}</a></li>
                        @else
                        <li class=""><a data-toggle="tab" href="{{ $data->nama }}">{{ $data->nama }}</a></li>
                        @endif
                        @php
                            $no++;
                        @endphp
                    ...
                    <div class="tab-content-cls">
                        ...
                        <div id="{{ $result->nama }}" class="tab-content active default">
                            <div class="no-slider row">
                                @foreach ($result->barang as $produk)
                                <div class="product-box mt-3">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="cart-info cart-wrap">
                                            <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                ...
                                                <a href="{{ route('home.show', $produk->slug )}}" data-bs-toggle="modal"
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <h4>Rp. {{ number_format($produk->one_detail_barang->harga) }}</h4>
                                        <ul class="color-variant">
                                            <li class="bg-light0"></li>
                                            <li class="bg-light1"></li>
                                            <li class="bg-light2"></li>
            ...
            <div class="col-md-4 service-block">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4>Gratis Ongkir</h4>
                        <p>Gratis pengiriman ke berbagai wilayah</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 service-block">
