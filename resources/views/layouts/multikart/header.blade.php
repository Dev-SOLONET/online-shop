                                                    ...
                                                    <div class="row m-0">
                                                        ...
                                                        <div class="col-xl-4">
                                                            <a href="#" class="mega-menu-banner"><img
                                                                    src="{{ url('multikart/assets/images/mega-menu/fashion.jpg') }}" alt=""
                                        ...
                                        <ul class="mega-menu full-mega-menu">
                                            <li>
                                                <div class="container">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <img src="{{ url('multikart/assets/images/menu-banner.jpg') }}"
                                    ...
                                    <li class="onhover-div mobile-cart">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="me-3"
                                                            src="{{ url('multikart/assets/images/fashion/product/1.jpg') }}"></a>
                                            ...
                                            <li>
                                                <div class="media">
                                                    <a href="#"><img alt="" class="me-3"
                                                            src="{{ url('multikart/assets/images/fashion/product/2.jpg') }}"></a>
                                                    <div class="media-body">
                                                        <a href="#">
                                                            <h4>item name</h4>
                                                        </a>
